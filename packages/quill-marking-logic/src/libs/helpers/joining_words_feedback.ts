...
export function getFeedbackForMissingWord(missingWord:string): string|null {
  if (missingWord) {
...
export function getconceptUIDForMissingWord(missingWord: string): string|null {
...
function cleanMissingWord(missingWord: string): string {
