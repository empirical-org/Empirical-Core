...
describe('The checking a diagnostic question', () => {
  ...
  describe('first matchers - original sentence', () => {
    it('should be able to find an exact match', () => {
      const matchedResponse = checkDiagnosticQuestion(responses[0].question_uid, responses[0].text, responses, responses[0].question_uid);
    ...
    it('should be able to find a case insensitive match', () => {
      ...
      const matchedResponse = checkDiagnosticQuestion(responses[0].question_uid, questionString, responses, responses[0].question_uid);
