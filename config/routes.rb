...
EmpiricalGrammar::Application.routes.draw do
  ...
  %w(tooltip board press blog_posts supporters middle_school story learning develop mission faq tos privacy activities new impact stats team premium teacher_resources press_kit play media news ideas).each do |page|
