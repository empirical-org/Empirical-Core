...
EmpiricalGrammar::Application.routes.draw do
  ...
  %w(tooltip beta board press blog_posts supporters partnerships middle_school story learning develop mission faq tos privacy activities new impact stats team premium teacher_resources media_kit play media news home_new diagnostic_landing_page).each do |page|
