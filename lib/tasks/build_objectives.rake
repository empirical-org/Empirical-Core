  ...
  module ObjectiveCreator
    def self.data
       [{name: 'Create a Classroom', section: 'Getting Started', help_info: 'http://support.quill.org/knowledgebase/articles/369605', action_url: '/teachers/classrooms/new', section_placement: 1 },
        ...
        {name: 'Assign Quill Diagnostic Activity', section: 'Assign An Activity From Each Tool', help_info: '/tools/connect', action_url: '/teachers/classrooms/assign_activities/create-unit?tool=connect', section_placement: 1},
        {name: 'Assign Quill Diagnostic Activity', section: 'Assign An Activity From Each Tool', help_info: '/tools/diagnostic', action_url: '/teachers/classrooms/assign_activities/create-unit?tool=lessons', section_placement: 1},
        {name: 'Assign Quill Diagnostic Activity', section: 'Assign An Activity From Each Tool', help_info: '/tools/proofreader', action_url: '/teachers/classrooms/assign_activities/create-unit?tool=passage', section_placement: 1},
        {name: 'Assign Quill Diagnostic Activity', section: 'Assign An Activity From Each Tool', help_info: '/tools/grammar', action_url: '/teachers/classrooms/assign_activities/create-unit?tool=sentence', section_placement: 1},
