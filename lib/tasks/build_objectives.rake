  ...
  module ObjectiveCreator
    def self.data
       [{name: 'Create a Classroom', section: 'Getting Started', help_info: 'http://support.quill.org/knowledgebase/articles/369605', action_url: '/teachers/classrooms/new', section_placement: 1 },
        ...
        {name: 'Build Your Own Activity Pack', section: 'Getting Started', help_info: 'http://support.quill.org/knowledgebase/articles/369614', action_url: 'http://localhost:3000/teachers/classrooms/activity_planner', section_placement: 4},
