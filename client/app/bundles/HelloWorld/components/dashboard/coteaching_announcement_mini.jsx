  ...
  miniBuilder() {
    return (
      <div className="mini_content">
        ...
        <div>
          <img style={{marginTop: '7px', width: '67px'}} src="https://assets.quill.org/images/illustrations/high-five-illustrationx2.png"/>
        </div>
        <p style={{ padding: '0px 15px', lineHeight: '1.57', fontFamily: 'lucida-grande, adelle-sans, helvetica', }}>
        You can now add co-teachers to your classes. Co-teachers can manage classes, assign activities and view reports.
      </p>
        <a style={{display: 'block', marginBottom: '12px'}} href="/teachers/classrooms#invite-coteachers"><button style={{ maxWidth: '233px', width: '100%', paddingBottom: '13px', marginTop: '15px'}} className="button button-white beta">Add Co-Teachers</button></a>
