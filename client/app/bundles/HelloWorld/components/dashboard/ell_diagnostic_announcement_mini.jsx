    ...
    return (
      <div className="mini_content">
        ...
        <div>
          ...
          <a href='https://medium.com/writing-with-quill/quill-org-launches-ell-diagnostic-ac2dd65de692'><button style={{fontWeight: 'normal', maxWidth: '233px', width: '100%', paddingBottom: '13px'}} className="button button-white beta">Learn More</button></a>
      </div>
    );
  },
