    ...
    miniBuilder() {
      return (
        <div className="mini_content">
          ...
          <div>
            <a href="/tools/diagnostic" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '8px', }}><img src="/images/lesson_icons_black.svg" style={{ height: '25px', marginRight: '10px', marginTop: '3px', }} /><p style={{ fontWeight: 'bold', fontSize: '18px', margin: '8px 0 0', }}>ELL Diagnostic</p></a>
          </div>
