      ...
      <div className="premium-flyer">
        <div className="inner-premium-flyer">
          <div className="content">
            ...
            <a className="download-button" href="https://assets.quill.org/documents/quill_premium.pdf" download="Quill Premium"><i className="fa fa-file-pdf-o" />Download Premium PDF</a>
          </div>
