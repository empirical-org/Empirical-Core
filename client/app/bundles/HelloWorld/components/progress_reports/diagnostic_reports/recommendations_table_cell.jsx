...
export default class RecommendationsTableCell extends React.Component{
  ...
  render() {
    let checkboxClass, checkboxOnClick
    if (this.props.previouslyAssigned) {
    ...
    return (
    <div className={'recommendations-table-row-item' + this.props.previouslyAssigned + this.props.recommended + this.props.selected}>
