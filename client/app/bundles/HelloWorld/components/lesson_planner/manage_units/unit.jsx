'use strict'
 ...
 export default  React.createClass({
  ...
  editStudentsLink: function(){
    return this.props.report || this.props.lesson ? null : <a className='edit-unit edit-students' href={`/teachers/classrooms/activity_planner/units/${this.props.data.unit.id}/students/edit`}>Edit Classes & Students</a>
  },
