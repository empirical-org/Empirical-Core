shared_context 'Unit Assignments Variables' do
  ...
  let!(:classroom_activity) { FactoryGirl.create(:classroom_activity, activity_id: activity.id, classroom_id: classroom.id, assigned_student_ids: [student.id], assign_on_join: false)}
