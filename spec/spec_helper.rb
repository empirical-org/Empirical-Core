...
# for use in our frontend tests. Simply call the method with the path_name of
# the API endpoint and then the JSON content that endpoint would return.
def save_mock_data(path_name, response)
  FileUtils.mkdir_p 'client/__mockdata__'
  File.write("client/__mockdata__/#{path_name}.json", response.body)
end
