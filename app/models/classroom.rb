class Classroom < ActiveRecord::Base
  ...
  has_many :students_classrooms, foreign_key: 'classroom_id', dependent: :destroy
  has_many :students, through: :students_classrooms, source: :students, inverse_of: :classrooms
