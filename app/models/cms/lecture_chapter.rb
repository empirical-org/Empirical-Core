class CMS::LectureChapter < ActiveRecord::Base
  ...
  has_many :questions
  attr_accessible :annotatable_text, :chart_embed_code, :citation_text, :discussion_text, :globe_embed_code, :lecture_id, :position, :quiz_embed_code, :reading_text, :slideshow_embed_code, :subtitle, :title, :youtube_embed_code
