class Teachers::UnitsController < ApplicationController
  ...
  def create
    ...
    unit_params['activities'].each do |_key, activity_data|
      activity_id = activity_data['id']
      due_date = activity_data['due_date']
      unit_params['classrooms'].each do |_key, classroom_data|
  ...
  def index
    ...
    units.each do |unit_id, classroom_activities|
      ...
      classroom_activities.each do |ca|
        if ca.assigned_student_ids.nil? || ca.assigned_student_ids.length == 0
