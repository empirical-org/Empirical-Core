...
const titleCards = {
  'fill in multiple blanks title card': '<h1>रिक्त भरें: A, An, The</h1><p>इस अनुभाग में, प्रत्येक वाक्य में दो या तीन रिक्त स्थान होंगे।</p><p>दी गई सूची से शब्द का उपयोग करके वाक्य को फिर से लिखना या रिक्त स्थान के लिए "कोई शब्द की आवश्यकता नहीं है" विकल्प चुनें</p>',
  'fill in single blanks title card': '<h1>रिक्त स्थान भरें</h1><p>इस अनुभाग में, आप एक वाक्य को पूरा करने के लिए सबसे अच्छा शब्द चुन लेंगे। आप एक वाक्य को दोबारा लिखेंगे, एक सूची से शब्दों में से एक के साथ रिक्त भरने के लिए।</p>',
  'sentence fragments title card': '<h1>पूर्ण वाक्य</h1><p>इस अनुभाग में, आप एक पूर्ण वाक्य बनाने के लिए शब्दों के एक समूह में जोड़ देंगे। संभव के रूप में कुछ शब्द जोड़ें</p>',
  'tense title card': '<h1>अतीत, वर्तमान, और भविष्य में तनाव</h1><p>इस अनुभाग में, आप वाक्य को शेष वाक्य के मुकाबले सही क्रिया में डालकर वाक्यों को ठीक कर देंगे।</p> ',
  'sentence combining title card': '<h1>वाक्यों  संयोजन</h1><p>इस अनुभाग में आप वाक्यों को एक वाक्य में जोड़ सकते हैं।</p><p>कभी-कभी आपको चुनने के लिए शब्दों में शामिल होने दिया जाएगा, और कभी-कभी आपको वाक्यों के संयोजन के अपने स्वयं के तरीके को चुनना होगा।</p><p>केवल शब्दों को जोड़ने या बदलने के लिए जब आप की आवश्यकता होती है, और वाक्यों का अर्थ समान रूप से रखने का प्रयास करें।</p>',
  'diagnostic intro text': '<h1>क्विल प्लेसमेंट गतिविधि</h1><p>वाक्यों लिखने पर आप 22 सवालों का जवाब दे रहे हैं यह एक परीक्षण नहीं है यह पता लगाने के लिए बस आप क्या जानते हैं</p><p>कुछ प्रश्न उन चीजों के बारे में हो सकते हैं जिन्हें आपने अभी तक नहीं सीखा है - ठीक है बस उन्हें उतना अच्छा उत्तर दें जितना कि आप कर सकते हैं।</p><p>एक बार जब आप समाप्त कर लेंगे Quill सिर्फ आपके लिए सीखने की योजना बनायेगा</p>',
