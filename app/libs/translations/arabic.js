...
const titleCards = {
  'fill in multiple blanks title card': '<h1>:املئ الفراغات</h1> <p>.في هذا الجزء من النشاط سيكون لكل جملة فراغين أو ثلاثة</p><p>.عليك استخدام واحدة من الكلمات في القائمة لملئ الفراغ أو ترك الفراغ اذا كنت تعتقد بان الفراغ لا يحتاج الى اي كلمه</p>',
