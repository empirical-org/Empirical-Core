...
ActiveRecord::Schema.define(version: 20_151_123_211_533) do
  ...
  add_index 'activities_unit_templates', %w(activity_id unit_template_id), name: 'aut', using: :btree
  add_index 'activities_unit_templates', %w(unit_template_id activity_id), name: 'uta', using: :btree
  ...
  add_index 'districts_users', %w(district_id user_id), name: 'index_districts_users_on_district_id_and_user_id', using: :btree
  ...
  add_index 'schools_users', %w(school_id user_id), name: 'index_schools_users_on_school_id_and_user_id', using: :btree
