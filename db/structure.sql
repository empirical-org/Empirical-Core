...
--
-- Name: schools_admins_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
CREATE UNIQUE INDEX unique_index_users_on_email ON users USING btree (email) WHERE ((id > 1555399) AND (email IS NOT NULL));
...
CREATE UNIQUE INDEX unique_index_users_on_google_id ON users USING btree (google_id) WHERE ((id > 1555399) AND (google_id IS NOT NULL));
