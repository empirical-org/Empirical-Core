  ...
  renderButton = () => {
    ...
    if (this.showNextQuestionButton()) {
      ...
      if (question.attempts.length > 0) {
        ...
        return <button className={buttonClass} onClick={this.handleSubmit} tabIndex="0" type="button">Recheck work</button>;
      } else {
        return <button className="quill-button focus-on-light large primary contained" onClick={this.handleSubmit} tabIndex="0" type="button">Submit</button>;
      }
    } else {
