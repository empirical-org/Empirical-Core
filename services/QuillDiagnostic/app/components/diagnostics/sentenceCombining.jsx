...
class PlayDiagnosticQuestion extends React.Component {
  ...
  render = () => {
    ...
    const button = responses ? <button className="quill-button focus-on-light large primary contained" onClick={this.handleSubmitResponse} tabIndex="0" type="button">Submit</button> : <button className="quill-button focus-on-light large primary contained disabled" tabIndex="0" type="button">Submit</button>;
    if (question) {
