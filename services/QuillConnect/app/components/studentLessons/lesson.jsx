...
const Lesson = React.createClass({
  ...
  componentWillReceiveProps(nextProps) {
    ...
    const thisPropsAttemptsLength = this.props.playLesson.currentQuestion && this.props.playLesson.currentQuestion.question && this.props.playLesson.currentQuestion.question.attempts ? this.props.playLesson.currentQuestion.question.attempts.length : 0
