...
const normalization = require('../app/actions/sessions.js');
const denormalizeSession = normalization.denormalizeSession;
const normalizeSession = normalization.normalizeSession;
