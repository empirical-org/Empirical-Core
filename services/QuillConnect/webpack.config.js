  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      'process.env': {
        ...
        EMPIRICAL_BASE_URL: JSON.stringify(process.env.EMPIRICAL_BASE_URL || 'https://www.quill.org'),
        QUILL_CMS: JSON.stringify(process.env.QUILL_CMS || 'https://cms.quill.org'),
