...
def test_grammar_errors(app):
    ...
    errors = [("He readed a book.", 3, grammarcheck.VERB_TENSE_ERROR),
              ...
              ("She hearded about the concert from my friend.", 4, grammarcheck.VERB_TENSE_ERROR),
              ("I was listen to music when you called.", 6, grammarcheck.VERB_TENSE_ERROR),
              ("We had sang a song before eating dinner.", 7, grammarcheck.VERB_TENSE_ERROR),
              ("I have eated at this resturaunt every week.", 7, grammarcheck.VERB_TENSE_ERROR),
              ("Have you ate pizza before?", 9, grammarcheck.VERB_TENSE_ERROR),
              ("Have you eaten pizza before?", None, None),
              ("Have you eaten pizza before.", 27, grammarcheck.QUESTION_MARK_ERROR),
              ("I have eaten pizza before", 19, grammarcheck.PUNCTUATION_ERROR),
              ("I have eaten pizza before.", None, None),
              ("Every repository has it's own README.", 21, grammarcheck.ITS_IT_S_ERROR),
              ...
              ("He drive a car.", 3, grammarcheck.SUBJECT_VERB_AGREEMENT_ERROR),
              ("He drives a car.", None, None),
              ("He owns a anteater.", 8, grammarcheck.ARTICLE_ERROR),
              ("He owns an anteater.", None, None),
              ("Do you see this anteater over there?", 11, grammarcheck.THIS_THAT_ERROR),
              ("Do you see that anteater over there?", None, None),
              ("Do you see that anteater over here?", 11, grammarcheck.THIS_THAT_ERROR),
              ("Do you see this anteater over here?", None, None),
              ("Do you see these koalas over there?", 11, grammarcheck.THIS_THAT_ERROR),
              ("Do you see those koalas over there?", None, None),
              ("Do you see those koalas over here?", 11, grammarcheck.THIS_THAT_ERROR),
              ("Do you see these koalas over here?", None, None),
              ("I do .", 5, grammarcheck.SPACING_ERROR),
              ("I do.", None, None),
              ("We have several woman on the board.", 16, grammarcheck.WOMAN_WOMEN_ERROR),
              ("We have several womans on the board.", 16, grammarcheck.WOMAN_WOMEN_ERROR),
              ("We have several women on the board.", None, None),
              ("We have only one women on the board.", 17, grammarcheck.WOMAN_WOMEN_ERROR),
              ("We have only one woman on the board.", None, None),
              ("We have too many mans on the board.", 17, grammarcheck.MAN_MEN_ERROR),
              ...
              ("If you're taller, than I will run away.", 18, grammarcheck.THAN_THEN_ERROR),
              ("If you're taller, then I will run away.", None, None),
              ("You and me make a great team.", 8, grammarcheck.SUBJECT_PRONOUN_ERROR),
              ("You and I make a great team.", None, None),
              ("He helped you and I so many times.", 18, grammarcheck.OBJECT_PRONOUN_ERROR),
              ("He helped you and me so many times.", None, None),
              ("It's my mothers house.", 8, grammarcheck.POSSESSIVE_NOUN_ERROR),
              ("It's my mother's house.", None, None),
              ("This village has 20000 inhabitants.", 17, grammarcheck.COMMAS_IN_NUMBERS_ERROR),
              ...
              ("this sentence does not start with a capital letter.", 0, grammarcheck.CAPITALIZATION_ERROR),
    ...
    for error, index, error_type in errors:
        with app.test_request_context(json={'entry': error, 'prompt_id': 000}):
            response = main.check_grammar(flask.request)
            ...
            if index is not None:
                ...
                assert data.get('highlight')[0]["category"] == error_type
                assert data.get('highlight')[0]["character"] == index
            else:
