...
module Comprehension
  class RegexCheckTest < ActiveSupport::TestCase
    setup do
      ...
      @rule = create(:comprehension_rule, rule_type: 'rules-based', prompts: [@prompt], suborder: 0)
    ...
    context '#feedback_object' do
      ...
      should 'return the highest priority feedback when two feedbacks exist' do
        new_rule = create(:comprehension_rule, rule_type: 'rules-based', prompts: [@prompt], suborder: 1)
