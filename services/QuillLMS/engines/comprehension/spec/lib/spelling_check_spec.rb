...
module Comprehension
  RSpec.describe(SpellingCheck, :type => :model) do
    context("#feedback_object") do
      it("return appropriate feedback attributes if there is a spelling error") do
      ...
      it("return appropriate feedback attributes if there is no spelling error") do
      ...
      it("return appropriate error if the endpoint returns an error") do
    ...
    context("#non_optimal_feedback_string") do
      it("use the fallback feedback if there is no spelling Rule with feedback") do
      ...
      it("use the feedback from the spelling rule if it is available") do
