...
### Determining Optimal
Here are two categories and examples. Determine 'optimum' value solely by picking which category the entry belongs in:


#### Examples in {'optimal' => true} category
```
%{optimal_examples}
```

#### Examples in {'optimal' => false} category
```
%{suboptimal_examples}
```
...
2. Follow the "Optimal Guidelines" and "Determining Optimal" and determine whether the full sentence is 'optimal'(true/false).
