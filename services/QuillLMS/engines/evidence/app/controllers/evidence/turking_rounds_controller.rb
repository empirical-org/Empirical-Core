module Evidence
  class TurkingRoundsController < ApiController
    ...
    def index
      @turking_rounds = Evidence::TurkingRound.all
    ...
    def create
      @turking_round = Evidence::TurkingRound.new(turking_round_params)
    ...
    private def set_turking_round
      @turking_round = Evidence::TurkingRound.find(params[:id])
    end
