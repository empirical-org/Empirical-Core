    ...
    context 'benchmarking', :benchmarking do
      ...
      context 'known slow API calls' do
        ...
        it 'without plagiarism' do
          ...
          puts format('Average known slow API non-plagiared runtime: %<runtime>.3f seconds', {runtime: (runtime / samples.length)})
        end
        ...
        it 'without plagiarism' do
          ...
          puts format('Average known slow API with plagiared runtime: %<runtime>.3f seconds', {runtime: (runtime / samples.length)})
        end
      end
    end
  end
