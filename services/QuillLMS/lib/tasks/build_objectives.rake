namespace :objectives do
  ...
  module ObjectiveCreator
    def self.data
       [{name: 'Create a Classroom', section: 'Getting Started', help_info: 'https://support.quill.org/getting-started-for-teachers/manage-classes/how-do-i-create-classes', action_url: '/teachers/classrooms?modal=create-a-class', section_placement: 1 },
        {name: 'Add Students', section: 'Getting Started', help_info: 'https://support.quill.org/getting-started-for-teachers/manage-classes/how-do-i-invite-students-to-my-classes', action_url: '/teachers/classrooms', section_placement: 2 },
        ...
        {name: 'Assign Entry Diagnostic', section: 'Getting Started', help_info: 'https://support.quill.org/getting-started-for-teachers/assigning-activities/how-can-i-assign-a-quill-diagnostic', action_url: '/teachers/classrooms/activity_planner/diagnostic', section_placement: 4 },
