...
RSpec.shared_context "Stripe Subscription Data" do
  include_context "Stripe Plan Data"
  include_context "Stripe Customer Data"

  let(:stripe_subscription_id) { 'sub_1KfpDIBuKMgoObiuqT3Hiw5u' }
