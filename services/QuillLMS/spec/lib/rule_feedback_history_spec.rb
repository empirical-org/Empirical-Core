...
RSpec.describe RuleFeedbackHistory, type: :model do
  ...
  describe '#generate_rulewise_report' do
    ...
    it 'should filter feedback histories by prompt id, used=true and time params' do
      ...
      f_h5 = create(:feedback_history, rule_uid: so_rule1.uid, prompt_id: 1, created_at: "2021-03-07T19:02:54.814Z", feedback_session_uid: '123-abc')
      f_h6 = create(:feedback_history, rule_uid: so_rule1.uid, prompt_id: 1, created_at: "2021-04-07T19:02:54.814Z", feedback_session_uid: '456-def')
