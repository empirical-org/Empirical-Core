...
RSpec.describe ActivitySessionFeedbackHistory, type: :model do
  ...
  context 'validations' do
    ...
    it { should validate_uniqueness_of(:feedback_session_uid) }
  end
  ...
  context '#self.get_feedback_history_session_uid' do
    it 'should create a new record if the activity_session_uid is new' do
      ...
      ActivitySessionFeedbackHistory.get_feedback_session_uid(1)
    ...
    it 'should always return the same uuid for a given input' do
      result = ActivitySessionFeedbackHistory.get_feedback_session_uid(1)
      expect(ActivitySessionFeedbackHistory.get_feedback_session_uid(1)).to eq(result)
    end
  end
end
