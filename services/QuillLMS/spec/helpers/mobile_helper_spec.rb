...
describe MobileHelper do
  ...
  describe '#render_content' do
    it 'should return content if device and type arguments match' do
      expect(helper.render_content('mobile', 'mobile', 'www.test.com')).to eq "<div class='video-section'>
    ...
    it 'should return nil if device and type arguments do not match' do
      expect(helper.render_content('mobile', 'desktop', 'www.test.com')).to eq nil
    end
  end
end
