  ...
  describe '#determine_active_subtab' do
    context 'matched path' do
      it 'should return the expected subtab string' do
        ...
        expect(helper.determine_active_subtab('/teachers/progress_reports/diagnostic_reports/#/activity_packs')).to eq(NavigationHelper::ACTIVITY_ANALYSIS)
        expect(helper.determine_active_subtab('/teachers/progress_reports/diagnostic_reports/#/diagnostics')).to eq(NavigationHelper::DIAGNOSTICS)
