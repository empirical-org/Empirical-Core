  ...
  describe "POST #create_or_update" do
    context "with valid params" do
      ...
      it "updates the filter selections for growth diagnostic dropdown filters" do
        ...
        admin_report_filter_selection = create(:admin_report_filter_selection, user: user, report: report, filter_selections: { 'group_by_value' => { 'value' => grade_string, 'label' => grade_string }, 'diagnostic_type_value' => {} })

        updated_filter_selections = {
          'group_by_value' => classroom_string,
          'diagnostic_type_value' => starter_diagnostic_option
        }
        updated_attributes = { report: report, filter_selections: updated_filter_selections }
        ...
        expect do
          ...
          .and change { admin_report_filter_selection.reload.filter_selections['diagnostic_type_value']['value'] }.from(nil).to(1663)
      end
