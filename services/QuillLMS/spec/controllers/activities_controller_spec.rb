...
describe ActivitiesController, type: :controller, redis: true do
  ...
  describe '#suggested_activities' do
    ...
    before do
      Evidence::Activity.create(parent_activity_id: production_activity1.id, notes: 'notes', title: 'title', ai_type: Evidence::Activity::GENAI)
      Evidence::Activity.create(parent_activity_id: production_activity2.id, notes: 'notes', title: 'title', ai_type: Evidence::Activity::GENAI)
      Evidence::Activity.create(parent_activity_id: beta1_activity.id, notes: 'notes', title: 'title', ai_type: Evidence::Activity::GENAI)
