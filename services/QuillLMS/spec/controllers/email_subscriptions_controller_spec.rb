...
RSpec.describe EmailSubscriptionsController, type: :controller do
  ...
  describe 'GET #current' do
    subject { get :current, params: { subscription_type: } }

    let(:email_subscription) { create(:email_subscription, user_id:) }
    let(:subscription_type) { email_subscription&.subscription_type }
