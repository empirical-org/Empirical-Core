...
RSpec.describe Demo::CreateAdminReport do
  ...
  it 'should create every classroom from the data hash, associated with the correct teacher, each with five students and between 10-30 activity sessions' do
