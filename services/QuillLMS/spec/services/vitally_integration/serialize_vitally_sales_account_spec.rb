...
describe 'SerializeVitallySalesAccount' do
  ...
  it 'generates student data' do
    ...
    active_old_student = create(:user, role: 'student', last_sign_in: Date.current - 2.year)
    inactive_student = create(:user, role: 'student', last_sign_in: Date.current - 2.year)
