...
EmpiricalGrammar::Application.routes.draw do
  ...
  namespace :teachers do
    ...
    namespace :progress_reports do
      ...
      post 'assign_independent_practice_activity_packs' => 'diagnostic_reports#assign_independent_practice_activity_packs'
      post 'assign_whole_class_instruction_activity_packs' => 'diagnostic_reports#assign_whole_class_instruction_activity_packs'
