...
module SidekiqQueue
  ...
  # INSTANT: Consistently low-latency jobs that should also always be the highest priority
  ...
  # CRITICAL_EXTERNAL: Jobs that rely on outside APIs, e.g. Google Classroom APIs
