const response = {
  data: {
    id: 85,
    name: "Advanced Fragments Group Lessons (2 Test)",
    time: 20,
    grades: ["4"],
    order_number: null,
    created_at: 1541169804,
    number_of_standards: 1,
    activity_info: null,
    author: {
      name: "Quill Staff",
      avatar_url: "https://assets.quill.org/images/authors/quill-staff.png",
    },
    unit_template_category: {
      primary_color: "#9c2bde",
      secondary_color: "#560684",
      name: "Elementary",
      id: 4,
    },
    activities: [
      {
        id: 739,
        name: "Lesson 1: Present Progressive Tense",
        flags: "{production}",
        description:
          "Students learn to use the present progressive form in the teacher-led lesson.",
        standard_level_name: "4th Grade CCSS",
        standard: {
          id: 4,
          name: "4.1b. The Progressive Tense",
          standard_category: { id: 2, name: "Verbs" },
        },
        classification: { key: "lessons", id: 6, name: "Quill Lessons" },
      },
      {
        id: 738,
        name: "Lesson 2: Past Progressive Tense",
        flags: "{production}",
        description:
      ...
      {
        id: 744,
        name: "Lesson 3: Present Perfect Progressive Tense",
        flags: "{production}",
        description:
  ...
  related_models: [
    {
      id: 70,
      name: "Perfect Tense Practice - Urban Animals",
      time: 50,
      grades: ["1", "2", "3", "4", "5"],
      order_number: 47,
      created_at: 1521484109,
      number_of_standards: 1,
      activity_info:
      ...
      activities: [
        {
          ...
          standard: {
            id: 12,
            name: "1.1e. Use Verbs to Convey a Sense of Past, Present, and Future",
            standard_category: { id: 2, name: "Verbs" },
          },
          classification: {
            key: "passage",
        ...
        },
        {
          ...
          name: "Monk Parakeets",
          flags: "{alpha}",
          description: "Present Perfect Tense practice.",
          standard_level_name: "1st Grade CCSS",
          standard: {
            id: 12,
            name: "1.1e. Use Verbs to Convey a Sense of Past, Present, and Future",
          ...
          classification: { key: "connect", id: 5, name: "Quill Connect" },
        },
        {
          id: 737,
          name: "Monk Parakeets",
      ...
      activities: [
        {
          ...
          flags: "{production}",
          description: "Proofread the passage and select the correct words.",
          standard_level_name: "1st Grade CCSS",
          standard: {
            id: 17,
            name: "1.1h. Use Determiners: Articles, Demonstratives",
            standard_category: { id: 4, name: "Determiners" },
          },
          classification: {
            key: "passage",
            id: 1,
        ...
        },
        {
          ...
          standard: {
            id: 6,
            name: "1.1i. Frequently Occurring Prepositions",
            standard_category: { id: 5, name: "Prepositions" },
          },
          classification: { key: "connect", id: 5, name: "Quill Connect" },
        },
        {
    ...
    {
      id: 8,
      name: "Irregular Plural Nouns / Possessives",
      time: 70,
      grades: ["4", "3", "2", "1"],
      order_number: 46,
      created_at: 0,
      ...
      author: {
        name: "Colette K.",
        avatar_url: "https://assets.quill.org/images/authors/colette-k.png",
      },
      unit_template_category: {
        primary_color: "#9c2bde",
        secondary_color: "#560684",
      ...
      activities: [
        {
          ...
          flags: "{production}",
          description: "Write ten sentences using possessive nouns.",
          standard_level_name: "1st Grade CCSS",
          standard: {
            id: 7,
            name: "1.1b. Use Common, Proper, and Possessive Nouns",
            standard_category: { id: 9, name: "Nouns & Pronouns" },
          },
          classification: { key: "sentence", id: 2, name: "Quill Grammar" },
        },
        {
          id: 152,
          name: "Possessive Nouns",
        ...
        {
          id: 179,
          name: "Form and Use Possessives",
          flags: "{production}",
          description: "Write ten sentences using and forming possessives.",
          standard_level_name: "3rd Grade CCSS",
          standard: {
            id: 42,
            name: "3.2d. Form and use Possessives",
            standard_category: { id: 9, name: "Nouns & Pronouns" },
          },
          classification: { key: "sentence", id: 2, name: "Quill Grammar" },
        },
        ...
        {
          id: 283,
          name: "Irregular Plural Nouns Ending With “ves”",
          flags: "{production}",
          description:
            "Rewrite the ten sentences with the correct usage of plural noun.",
          standard_level_name: "2nd Grade CCSS",
          standard: {
            id: 15,
            name: "2.1b. Use Irregular Plural Nouns",
            standard_category: { id: 9, name: "Nouns & Pronouns" },
          },
          classification: { key: "sentence", id: 2, name: "Quill Grammar" },
        },
        ...
        {
          id: 148,
          name: "Children, People",
          flags: "{archived}",
          description:
            "Write ten sentences with the irregular nouns children and people.",
          standard_level_name: "2nd Grade CCSS",
          standard: {
            id: 15,
            name: "2.1b. Use Irregular Plural Nouns",
        ...
        },
        {
          ...
          flags: "{production}",
          description:
            "Write eight sentences with the irregular nouns men and women.",
          standard_level_name: "2nd Grade CCSS",
          standard: {
            id: 15,
            name: "2.1b. Use Irregular Plural Nouns",
        ...
        },
        {
          ...
          flags: "{production}",
          description:
            "Write eight sentences with the irregular nouns feet and teeth.",
          standard_level_name: "2nd Grade CCSS",
          standard: {
            id: 15,
            name: "2.1b. Use Irregular Plural Nouns",
        ...
        {
          id: 149,
          name: "Mice, Goose, Deer",
          flags: "{production}",
          description:
            "Write nine sentences with the irregular nouns mice, goose, and deer.",
          standard_level_name: "2nd Grade CCSS",
          standard: {
            id: 15,
            name: "2.1b. Use Irregular Plural Nouns",
  ...
  referral_code: "demo-teacher-2851865",
}
