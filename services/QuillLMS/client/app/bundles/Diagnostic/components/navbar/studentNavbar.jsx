...
const handleSaveAndExitClick = () => {
  window.location.assign(`${process.env.VITE_DEFAULT_URL}/profile`);
}
  ...
  return(
    <header className='nav student-nav'>
      <div className="container">
        <div className="student-nav-section">
          <a aria-label="Quill" className="student-nav-item focus-on-dark" href={`${process.env.VITE_DEFAULT_URL}`} tabIndex="0">
            <img
              alt="Quill.org logo"
              src={quillLogoSrc}
            />
