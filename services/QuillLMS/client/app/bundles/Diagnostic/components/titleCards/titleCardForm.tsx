      ...
      <Modal>
        <div className="box confirmation-modal-container">
          ...
          <section className="button-container">
            <button className="quill-button-archived fun primary contained" onClick={this.handleConfirm}>Confirm</button>
            <button className="quill-button-archived fun primary contained" onClick={this.handleCancel}>Cancel</button>
          </section>
        </div>
      </Modal>
    )
