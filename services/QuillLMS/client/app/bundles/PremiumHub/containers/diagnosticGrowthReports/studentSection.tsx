    ...
    return(
      <div className="load-more-button-container">
        <div className="text-container">
          ...
          showDownloadLink && <p> • Please <button className={`quill-button small secondary focus-on-light`} onClick={createCsvReportDownload}>download this report</button> to view more than 500 results.</p>
        </div>
