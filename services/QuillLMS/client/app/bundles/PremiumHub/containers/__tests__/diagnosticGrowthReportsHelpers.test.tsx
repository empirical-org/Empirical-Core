...
const mockCombinedData = [{
  aggregate_rows: [
    {
      ...
      id: "5",
      name: "Grade 5",
      overallSkillGrowth: <p className="emphasized-content">+29%</p>,
    ...
    },
    {
      ...
      id: "7",
      name: "Grade 7",
      overallSkillGrowth: <p className="emphasized-content">+19%</p>,
  ...
  overallSkillGrowth: <p className="emphasized-content">+24%</p>,
