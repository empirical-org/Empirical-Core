const denormalizedSession = {
  currentQuestion: {
    ...
    flag: "production",
    prompt:
      "\u003cp\u003eThere are more \u003cu\u003ethan / then\u003c/u\u003e 300 million people in the United States.\u003c/p\u003e",
    answers: [
      {
    ...
    focusPoints: {
      "-LmR-7F8XTaK9qdN1htY": {
        text: "th[ae]n",
        feedback:
          "\u003cp\u003eTry again. Rewrite your sentence with one of the underlined words from the prompt.\u003c/p\u003e",
        conceptResults: {
    ...
    incorrectSequences: [
      {
        text: "(th[ea]n.*){2,}",
        feedback:
          "\u003cp\u003eTry again. Use only one of the underlined words from the prompt.\u003c/p\u003e",
        conceptResults: {
          N5VXCdTAs91gP46gATuvPQ: {
      ...
      },
      {
        text: "[Tt]hen",
        feedback:
          "\u003cp\u003eTry again. Use \u003cem\u003ethen\u003c/em\u003e to talk about the timing of events. Use\u003cem\u003e more than\u003c/em\u003e to compare amounts.\u003c/p\u003e",
        conceptResults: {
      ...
      },
      {
        text: "^[Tt]han(\\.)?$",
        feedback:
          "\u003cp\u003eGood work! Now write the whole sentence.\u003c/p\u003e",
        conceptResults: {
          N5VXCdTAs91gP46gATuvPQ: {
            name: "Structure | Sentence Quality | Including Details From Prompt",
            correct: false,
      ...
      },
      {
        text: "unit|||stat",
        feedback:
          "\u003cp\u003eTry again. Always capitalize the names of countries.\u003c/p\u003e",
        conceptResults: {
  ...
  answeredQuestions: [
    {
      ...
      flag: "production",
      prompt:
        "\u003cp\u003eFive is more \u003cu\u003ethan / then\u003c/u\u003e four.\u003c/p\u003e",
      answers: [
        {
      ...
      attempts: [
        {
          ...
          optimal: true,
          feedback:
            "\u003cb\u003eWell done!\u003c/b\u003e That's the correct answer.",
          child_count: 25117,
    ...
    },
    {
      ...
      flag: "production",
      prompt:
        "\u003cp\u003eThat was \u003cu\u003ethan / then\u003c/u\u003e; this is now.\u003c/p\u003e",
      answers: [
        {
      ...
      attempts: [
        {
          ...
          optimal: true,
          feedback:
            "\u003cp\u003e\u003cstrong\u003eWell done!\u003c/strong\u003e That\u0026#x27;s the correct answer.\u003c/p\u003e",
          child_count: 57685,
      ...
      incorrectSequences: [
        ...
        },
        {
          ...
          text: "[Tt]han",
          feedback:
            "\u003cp\u003eTry again. Use \u003cem\u003ethan\u003c/em\u003e to compare things. Use \u003cem\u003ethen\u003c/em\u003e to talk about the timing of events. \u003c/p\u003e",
          conceptResults: {
            VuTHlr5mg3wudXOOJQXuNw: {
        ...
        },
        {
          ...
          text: "then( )?(,|\\.)?( )?[Tt]his",
          feedback:
            "\u003cp\u003eGood work! Now use a semicolon to join the ideas.\u003c/p\u003e",
          conceptResults: {
        ...
        },
        {
          ...
          text: "then;this",
          feedback:
            "\u003cp\u003eCheck your spacing. Always put a space after a semicolon.\u003c/p\u003e",
          conceptResults: {
  ...
  unansweredQuestions: [
    {
      ...
      flag: "production",
      prompt:
        "\u003cp\u003eIf you finish your dinner, \u003cu\u003ethan / then\u003c/u\u003e you can have dessert.\u003c/p\u003e",
      answers: [
        {
      ...
      incorrectSequences: [
        ...
        },
        {
          text: "desert",
          feedback:
            "\u003cp\u003eTry again. Use \u003cem\u003edesert\u003c/em\u003e to talk about the place. Use \u003cem\u003edessert\u003c/em\u003e to talk about a sweet treat.\u003c/p\u003e",
          conceptResults: {
        ...
        },
        {
          ...
          feedback:
            "\u003cp\u003eGood work! Now add a missing period.\u003c/p\u003e",
          conceptResults: {
        ...
        },
        {
          text: "er the",
          feedback:
            "\u003cp\u003eTry again. Don\u0026#x27;t forget to add a comma.\u003c/p\u003e",
          conceptResults: {
    ...
    },
    {
      ...
      flag: "production",
      prompt:
        "\u003cp\u003eI would rather have fun \u003cu\u003ethan / then\u003c/u\u003e be bored.\u003c/p\u003e",
      answers: [
        {
      ...
      incorrectSequences: [
        ...
        },
        {
          text: "[Tt]hen",
          feedback:
            "\u003cp\u003eTry again. Use \u003cem\u003ethen\u003c/em\u003e to talk about the timing of events. Use \u003cem\u003ethan\u003c/em\u003e to compare things, like having fun and being bored.\u003c/p\u003e",
          conceptResults: {
            OHoxJvIruMUR095tBZWZ7Q: {
              name: "Commonly Confused Words | Than, Then | Than",
              correct: false,
    ...
    },
    {
      ...
      flag: "production",
      prompt:
        "\u003cp\u003eThere was nice weather for a while, but \u003cu\u003ethan / then\u003c/u\u003e a storm came.\u003c/p\u003e",
      answers: [
        {
      ...
      incorrectSequences: [
        ...
        },
        {
          text: "hile but then",
          feedback:
            "\u003cp\u003eGood work! Now remember to use a comma before \u003cem\u003ebut\u003c/em\u003e when it joins two complete sentences.\u003c/p\u003e",
          conceptResults: {
        ...
        },
        {
          text: "ut( )?,",
          feedback:
            "\u003cp\u003eTry again. Check the placement of your comma.\u003c/p\u003e",
          conceptResults: {
            GiUZ6KPkH958AT8S413nJg: {
              name: "Conjunctions | Coordinating Conjunctions | Comma Before Coordinating Conjunctions",
              correct: false,
        ...
        },
        {
          text: "awhile",
          feedback:
            "\u003cp\u003eCheck your spacing. \u003cem\u003eA while\u003c/em\u003e is two words.\u003c/p\u003e",
          conceptResults: {
    ...
    },
    {
      ...
      flag: "production",
      prompt:
        "\u003cp\u003eHer speakers are much louder \u003cu\u003ethan / then\u003c/u\u003e mine.\u003c/p\u003e",
      answers: [
        {
      ...
      incorrectSequences: [
        ...
        },
        {
          text: "[Tt]hen",
          feedback:
            "\u003cp\u003eTry again. Use \u003cem\u003ethen\u003c/em\u003e to talk about the timing of events. Use \u003cem\u003ethan\u003c/em\u003e to compare things, like how loud her speakers are and how loud mine are.\u003c/p\u003e",
          conceptResults: {
            OHoxJvIruMUR095tBZWZ7Q: {
              name: "Commonly Confused Words | Than, Then | Than",
              correct: false,
