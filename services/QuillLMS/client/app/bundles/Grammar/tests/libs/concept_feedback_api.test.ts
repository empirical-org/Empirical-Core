...
describe('ConceptFeedbackApi calls', () => {
  ...
  describe('create', () => {
    it('should call requestPost', () => {
      ...
      expect(mockRequestPost).toHaveBeenLastCalledWith(url, {concept_feedback: MOCK_CONTENT}, null, expect.any())
    })
  })
  ...
  describe('update', () => {
    it('should call requestPut', () => {
      ...
      expect(mockRequestPut).toHaveBeenLastCalledWith(url, {concept_feedback: MOCK_CONTENT}, null, expect.any())
    })
  })
  ...
  describe('remove', () => {
    it('should call requestDelete', () => {
      ...
      expect(mockRequestDelete).toHaveBeenLastCalledWith(url, null, null, expect.any())
    })
  })
})
