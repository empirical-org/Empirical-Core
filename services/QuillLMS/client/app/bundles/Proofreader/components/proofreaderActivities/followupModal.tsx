      ...
      <div aria-live="polite" className="followup-modal-container" ref={(node) => this.modal = node} tabIndex={-1}>
        ...
        <div className="followup-modal">
          ...
          <div className="button-section">
            <button className="quill-button-archived medium secondary outlined focus-on-light" onClick={goToLMS} type="button">Save and exit</button>
            <button className="quill-button-archived medium primary contained focus-on-light" onClick={goToFollowupPractice} type="button">Begin</button>
          </div>
        </div>
      </div>
    )
