...
class PlayDiagnosticQuestion extends React.Component {
  ...
  render() {
    ...
    const button = responses ? <button className="quill-button-archived focus-on-light large primary contained" onClick={this.handleResponseSubmission} type="button">Submit</button> : <button className="quill-button-archived focus-on-light large primary contained disabled" type="button">Submit</button>;
    if (question) {
