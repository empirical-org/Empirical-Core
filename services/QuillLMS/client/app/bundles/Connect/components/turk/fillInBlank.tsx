...
export class PlayFillInTheBlankQuestion extends React.Component<any, any> {
  ...
  render() {
    ...
    const button = responses ? <button className="quill-button-archived focus-on-light large primary contained" onClick={this.handleSubmitResponse} type="button">{this.getSubmitButtonText()}</button> : <button className="quill-button-archived focus-on-light large primary contained disabled" type="button">Submit</button>;
    return (
