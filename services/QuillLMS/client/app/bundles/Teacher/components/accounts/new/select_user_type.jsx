...
import { ADMIN, Card, INDIVIDUAL_CONTRIBUTOR, STUDENT, TEACHER, networkIcon } from '../../../../Shared/index'
import AssignActivityPackBanner from '../assignActivityPackBanner'

const studentPencilImg = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/onboarding/student-pencil-colored.svg`
const teacherChalkboardImg = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/onboarding/teacher-chalkboard-colored.svg`
const homeSchoolImg = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/onboarding/home-building-colored.svg`

export class SelectUserType extends React.Component {
  setRoleOnSession = (role) => {
    requestPost(`${process.env.VITE_DEFAULT_URL}/account/role`, { role, },
      (body) => {
