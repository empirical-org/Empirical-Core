...
const higherEdSrc = `${import.meta.env.VITE_PROCESS_ENV_CDN_URL}/images/onboarding/school-campus.svg`
const otherSrc = `${import.meta.env.VITE_PROCESS_ENV_CDN_URL}/images/onboarding/business-building.svg`
const mapSearchImgSrc = `${import.meta.env.VITE_PROCESS_ENV_CDN_URL}/images/accounts/map-search.svg`
