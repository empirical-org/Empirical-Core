...
const EVIDENCE_ICON_SRC = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/icons/tool-evidence-light-gray.svg`

export const AppLegend = () => {
  const diagnostic = (
    <a className="icon focus-on-light" href={`${process.env.VITE_DEFAULT_URL}/tools/diagnostic`} rel="noopener noreferrer" target="_blank">
  ...
  const lessons = (
    <a className="icon focus-on-light" href={`${process.env.VITE_DEFAULT_URL}/tools/lessons`} rel="noopener noreferrer" target="_blank">
  ...
  const connect = (
    <a className="icon focus-on-light" href={`${process.env.VITE_DEFAULT_URL}/tools/connect`} rel="noopener noreferrer" target="_blank">
  ...
  const proofreader = (
    <a className="icon focus-on-light" href={`${process.env.VITE_DEFAULT_URL}/tools/proofreader`} rel="noopener noreferrer" target="_blank">
  ...
  const grammar = (
    <a className="icon focus-on-light" href={`${process.env.VITE_DEFAULT_URL}/tools/grammar`} rel="noopener noreferrer" target="_blank">
