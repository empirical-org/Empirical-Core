...
const springboard = () => [
  ...
  },
  {
    ...
    answer: (
      <div>
        ...
        <p className="college-board-q-and-a-text"><a href="https://support.quill.org/en/articles/1065187-how-can-i-assign-activities-in-a-specific-order" rel="noopener noreferrer" target="_blank">This article explains how you can use deadlines to help students pace themselves</a>.</p>
      </div>
    )
  },
  {
  ...
  },
  {
    ...
    answer: (
      <div>
        <p className="college-board-q-and-a-text">If you create a free account on Quill.org, you will be able to assign additional activities from any of Quill’s 5 tools:</p>
        <ul>
          <li>
            <p>Quill Connect</p>
            <p className="college-board-q-and-a-text">Students combine multiple ideas into a single sentence using the evidence-based strategy of sentence combining. Students receive instant feedback. *Note*: All activities recommended based on survey results are in Quill Connect.</p>
          </li>
          <li>
            <p>Quill Grammar</p>
            <p className="college-board-q-and-a-text">Students practice basic grammar skills, from using correct capitalization to correcting commonly confused words.</p>
          </li>
          <li>
            <p>Quill Proofreader</p>
            <p className="college-board-q-and-a-text">Students practice editing skills by correcting errors in passages. Students receive personalized follow-up activities based on their results.</p>
          </li>
          <li>
            <p>Quill Lessons</p>
