  ...
  totalScoreOrNot = () => {
    ...
    const actClassId = data.activity ? data.activity.classification.id : data.activity_classification_id;
     if (Number(actClassId) === 4 && data.percentage) {
      ...
      totalScoreOrNot = <p style={{ fontSize: '13px', color: '#3b3b3b', }}>Quill Comprehension does not provide a score. You can click to view your student’s answers from this lesson.</p>;
