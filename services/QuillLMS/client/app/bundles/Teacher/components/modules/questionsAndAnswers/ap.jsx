  ...
  },
  {
    ...
    answer: (
      <div>
        ...
        <p className="college-board-sub-header">AP Writing Practice - <a href="https://www.quill.org/activities/packs/139" rel="noopener noreferrer" target="_blank">Complex Sentences</a></p>
        ...
        <p className="college-board-sub-header">AP Writing Practice - <a href="https://www.quill.org/activities/packs/140" rel="noopener noreferrer" target="_blank">Relative Clauses</a></p>
        ...
        <p className="college-board-sub-header">AP Writing Practice - <a href="https://www.quill.org/activities/packs/143" rel="noopener noreferrer" target="_blank">Appositive Phrases</a></p>
        ...
        <p className="college-board-sub-header">AP Writing Practice - <a href="https://www.quill.org/activities/packs/144" rel="noopener noreferrer" target="_blank">Participial Phrases</a></p>
        ...
        <p className="college-board-sub-header">AP Writing Practice - <a href="https://www.quill.org/activities/packs/192" rel="noopener noreferrer" target="_blank">Parallel Structure</a></p>
        ...
        <p className="college-board-sub-header">AP Writing Practice - <a href="https://www.quill.org/activities/packs/141" rel="noopener noreferrer" target="_blank">Compound-Complex Sentences</a></p>
        ...
        <p className="college-board-sub-header">AP Writing Practice - <a href="https://www.quill.org/activities/packs/142" rel="noopener noreferrer" target="_blank">Advanced Combining</a></p>
