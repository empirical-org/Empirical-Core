    ...
    <div className="section-wrapper">
      <div className="container cb-message-container">
        ...
        <div className="quote-container">
          <img src="https://assets.quill.org/images/college_board/exaggerated-quote-left.svg" id="first-quote"/>
          ...
          <img src="https://assets.quill.org/images/college_board/exaggerated-quote-right.svg" id="second-quote"/>
        </div>
      </div>
    </div>
