...
import { COLLEGE_BOARD_SLUG, SPRING_BOARD } from '../assignment_flow/assignmentFlowConstants'
...
const generateLink = (isPartOfAssignmentFlow, unitTemplateId) => {
  if (isPartOfAssignmentFlow) { return `/assign/featured-activity-packs/${unitTemplateId}?${COLLEGE_BOARD_SLUG}=${SPRING_BOARD}` }

  return `/activities/packs/${unitTemplateId}`
}

const SpringBoard = ({ isPartOfAssignmentFlow }: SpringBoardContainerProps) => {
      ...
      <div className="container pre-ap-header-container">
        <div className="header-left">
          ...
          <div className="header-text-container">
            ...
            <a className="quill-button large primary contained focus-on-light" href="https://www.quill.org/account/new" rel="noopener noreferrer" target="_blank">Get started</a>
          </div>
        </div>
