        ...
        <div className="container college-board-activities-section">
          ...
          <div className="activity-container">
            <div className="activity-header-container">
              ...
              <a className="quill-button-archived medium primary outlined view-button focus-on-light" href={generateLink({ isPartOfAssignmentFlow, unitTemplateId: PRE_AP_WRITINGS_SKILLS_1_UNIT_TEMPLATE_ID, slug: PRE_AP_SLUG })} rel="noopener noreferrer" target={isPartOfAssignmentFlow ? '' : "_blank"}>View</a>
            </div>
          ...
          <div className="activity-container">
            <div className="activity-header-container">
              ...
              <a className="quill-button-archived medium primary outlined view-button focus-on-light" href={generateLink({ isPartOfAssignmentFlow, unitTemplateId: PRE_AP_WRITINGS_SKILLS_2_UNIT_TEMPLATE_ID, slug: PRE_AP_SLUG })} rel="noopener noreferrer" target={isPartOfAssignmentFlow ? '' : "_blank"}>View</a>
            </div>
            <div className="activity-text-container">
          ...
          <div className="activity-container">
            <div className="activity-header-container">
              ...
              <a className="quill-button-archived medium primary outlined view-button focus-on-light" href={generateLink({ isPartOfAssignmentFlow, unitTemplateId: ELL_STARTER_DIAGNOSTIC_UNIT_TEMPLATE_ID, slug: PRE_AP_SLUG })} rel="noopener noreferrer" target={isPartOfAssignmentFlow ? '' : "_blank"}>View</a>
            </div>
            <div className="activity-text-container">
          ...
          <div className="activity-container">
            <div className="activity-header-container">
              ...
              <a className="quill-button-archived medium primary outlined view-button focus-on-light" href={generateLink({ isPartOfAssignmentFlow, unitTemplateId: ELL_INTERMEDIATE_DIAGNOSTIC_UNIT_TEMPLATE_ID, slug: PRE_AP_SLUG })} rel="noopener noreferrer" target={isPartOfAssignmentFlow ? '' : "_blank"}>View</a>
            </div>
            <div className="activity-text-container">
          ...
          <div className="activity-container">
            <div className="activity-header-container">
              ...
              <a className="quill-button-archived medium primary outlined view-button focus-on-light" href={generateLink({ isPartOfAssignmentFlow, unitTemplateId: ELL_ADVANCED_DIAGNOSTIC_UNIT_TEMPLATE_ID, slug: PRE_AP_SLUG })} rel="noopener noreferrer" target={isPartOfAssignmentFlow ? '' : "_blank"}>View</a>
            </div>
            <div className="activity-text-container">
