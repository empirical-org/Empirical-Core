...
export default class RemoveUnsyncedStudents extends React.Component {
  ...
  handleUnsyncedStudentsByClassroomListing = () => {
    ...
    requestGet(
      `${process.env.VITE_DEFAULT_URL}/teacher_fix/list_unsynced_students_by_classroom?teacher_identifier=${teacherIdentifier}`,
      (body) => {
  ...
  handleUnsyncedStudentsRemoval = () => {
    ...
    requestPost(
      `${process.env.VITE_DEFAULT_URL}/teacher_fix/remove_unsynced_students`,
