    ...
    <div className="modal-container welcome-modal-container">
      ...
      <div className="quill-modal explore-demo-modal">
        <div className="modal-body">
          ...
          <button className="quill-button-archived contained primary medium" onClick={goToDemo} type="button">Let&apos;s go!</button>
          <button className="quill-button-archived contained secondary medium outlined cancel-button" onClick={close} type="button">Cancel</button>
        </div>
      </div>
    </div>
  )
