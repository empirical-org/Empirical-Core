  ...
  miniBuilder: function() {
    return (
      <div className="mini_content">
        ...
        <a href='https://medium.com/writing-with-quill/quill-org-launches-ell-diagnostic-ac2dd65de692' target="_blank"><button className="button button-white beta" style={{fontWeight: 'normal', maxWidth: '233px', width: '100%', paddingBottom: '13px'}}>Learn More</button></a>
      </div>
    );
  },
