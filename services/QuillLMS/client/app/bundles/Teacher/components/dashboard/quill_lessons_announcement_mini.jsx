    ...
    miniBuilder() {
      return (
        <div className="mini_content">
          ...
          <a href="https://medium.com/writing-with-quill/quill-launches-quill-lessons-fb983f2b8970" target="_blank"><button className="button button-white beta" style={{ fontWeight: 'normal', maxWidth: '233px', width: '100%', paddingBottom: '13px', }}>Learn More</button></a>
        </div>
      );
    },
