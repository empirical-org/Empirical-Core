...
const classroomActivitiesSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/pages/dashboard/illustrations-classroom-activities-2.svg`

const exploreDemoLink = `${process.env.VITE_DEFAULT_URL}/teachers/view_demo`
