...
describe('ActivityDetails component', () => {
  const baseData = { activity_classification_id: '4', caId: '12345', name: 'Sentence Structure Diagnostic', percentage: '1', updated: '2016-10-17 00:05:50.361093', userId: '666'};
  const withSessions = {...baseData, sessions: [{percentage: '0.5', completed_at: '2016-09-30 00:05:50.361093'}, {percentage: '1', completed_at: '2016-10-17 00:05:50.361093'}]}

  it('should render div with appropriate class name depending on presence of sessions', () => {
    const wrapperNoConcepts = shallow(<ActivityDetails data={baseData} />);
    const wrapperWithConcepts = shallow(<ActivityDetails data={withSessions} />);
  ...
  it('should render the objective', () => {
    const wrapper = shallow(<ActivityDetails
      data={Object.assign({}, baseData, { activity_description: 'Combine sentences to create 9 sentences that have an appositive phrase in the middle of the sentence.', sessions: [{ metadata: null, description: 'Combine sentences to create 9 sentences that have an appositive phrase in the middle of the sentence.', name: null, completed_at: null, dueDate: '2016-11-04 00:00:00', }], })}
    />);
  ...
  it('should render due date text if due', () => {
    const wrapper = shallow(
      <ActivityDetails
        data={Object.assign({}, baseData, {sessions: [], dueDate: '2016-11-04 00:00:00', sessions: [{ metadata: null, description: 'Combine sentences to create 9 sentences that have an appositive phrase in the middle of the sentence.', name: null, completed_at: null, }], })}
      />
    );
