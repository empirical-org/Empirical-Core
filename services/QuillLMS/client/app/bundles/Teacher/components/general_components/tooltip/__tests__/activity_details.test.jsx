...
describe('ActivityDetails component', () => {
  ...
  it('should render completed text if complete', () => {
    const wrapperWithCompletedAt = shallow(
      <ActivityDetails
        data={Object.assign({}, baseData, { concept_results: [{ metadata: { answer: 'When he makes a mistake, show him how to improve.', browser: 'Chrome', correct: 1, directions: 'Rewrite the sentence so that the gender or number is consistent.', os: 'Chromium OS', prompt: 'When he makes a mistake, show her how to improve.', questionUid: '-Jzw0qjO5owyFPUAwDJ8', questionUrl: 'https://grammar.quill.org/cms/concepts/-Jzw0qjP5tpJMplbm7j2/questions/-Jzw0qjO5owyFPUAwDJ8', wpm: 17, questionNumber: 1, }, description: 'Write eight sentences recognizing inappropriate shifts in pronoun number or gender.', name: 'Pronoun Shift: Singular', completed_at: '2017-03-31 15:34:27.043575', due_date: null, }, { metadata: { answer: 'When my mom was in school, she would play jacks all the time.', browser: 'Chrome', correct: 1, directions: 'Rewrite the sentence, filling in the blank with an appropriate pronoun.', os: 'Chromium OS', prompt: 'When my mom was in school, _____ would play jacks all the time.', questionUid: '-Jzw0qjO5owyFPUAwDJA', questionUrl: 'https://grammar.quill.org/cms/concepts/-Jzw0qjP5tpJMplbm7j2/questions/-Jzw0qjO5owyFPUAwDJA', wpm: 11, questionNumber: 2, }, description: 'Write eight sentences recognizing inappropriate shifts in pronoun number or gender.', name: 'Pronoun Shift: Singular', completed_at: '2017-03-31 15:34:27.043575', due_date: null, }], })}
      />
    );
