...
const PreviewCard = (props) =>(
  <a className={`preview-card-link ${props.color ? props.color : 'green'}`} href={props.link} target={props.externalLink ? "_blank" : "_self"}>
    ...
    <a className="quill-button-archived fun contained primary focus-on-light" href={props.link} rel="noopener noreferrer" target={props.externalLink ? "_blank" : "_self"}>Read</a>
  </a>
)
