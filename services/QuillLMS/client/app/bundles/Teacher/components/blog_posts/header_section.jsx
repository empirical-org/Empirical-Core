  ...
  return(
    <div className="header-section">
      ...
      <form action={`${process.env.DEFAULT_URL}/${TEACHER_CENTER_SLUG}/search`}>
        ...
        {showCancelSearchButton ? <img alt="" className="cancel-button" onClick={() => window.location.href = `${process.env.DEFAULT_URL}/${TEACHER_CENTER_SLUG}/`} src={`${process.env.CDN_URL}/images/icons/CloseIcon.svg`} /> : null}
      </form>
    </div>
  )
}
