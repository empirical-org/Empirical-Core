...
const SlideOne = () => {
  return (
    <div className='slide lessons-slide-one' key='one'>
      <div className="media">
        <img alt="" className="illustration" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/tutorials/lessons/slide_1.svg`} />
        <img alt="" className="caption" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/tutorials/lessons/slide_1_text.svg`} />
      </div>
      <div className="text">
...
const SlideTwo =() => {
  return (
    <div className='slide lessons-slide-two' key='two'>
      <div className="media">
        <img alt="" className="illustration" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/tutorials/lessons/slide_2.svg`} />
        <img alt="" className="caption" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/tutorials/lessons/slide_2_text.svg`} />
      </div>
      <div className="text">
...
const SlideThree =() => {
  return (
    <div className='slide lessons-slide-three' key='three'>
      <div className="media">
        <img alt="" className="illustration" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/tutorials/lessons/slide_3.svg`} />
        <img alt="" className="caption" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/tutorials/lessons/slide_3_text.svg`} />
      </div>
      <div className="text">
...
const SlideFour =() => {
  return (
    <div className='slide lessons-slide-four' key='four'>
      <div className="media">
        <img alt="" className="illustration" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/tutorials/lessons/slide_4.svg`} />
        <img alt="" className="caption" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/tutorials/lessons/slide_4_text.svg`} />
      </div>
      <div className="text">
...
const SlideSix =() => {
  return (
    <div className='slide lessons-slide-six' key='six'>
      <div className="media">
        <img alt="" className="illustration" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/tutorials/lessons/slide_6.svg`} />
        <img alt="" className="caption" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/tutorials/lessons/slide_6_text.svg`} />
      </div>
      <div className="text">
