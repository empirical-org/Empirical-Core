...
const SlideOne = () => {
  return (<div className='slide lessons-slide-one' key='one'>
    <div className="media">
...
const SlideTwo =() => {
  return (<div className='slide lessons-slide-two' key='two'>
    <div className="media">
...
const SlideThree =() => {
  return (<div className='slide lessons-slide-three' key='three'>
    <div className="media">
...
const SlideFour =() => {
  return (<div className='slide lessons-slide-four' key='four'>
    <div className="media">
