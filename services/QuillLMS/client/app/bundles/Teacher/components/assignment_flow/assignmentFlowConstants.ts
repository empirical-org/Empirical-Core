...
export const STARTER_DIAGNOSTIC_POST_UNIT_TEMPLATE_ID = 0
export const INTERMEDIATE_DIAGNOSTIC_UNIT_TEMPLATE_ID = 100
export const INTERMEDIATE_DIAGNOSTIC_POST_UNIT_TEMPLATE_ID = 0
export const ADVANCED_DIAGNOSTIC_UNIT_TEMPLATE_ID = 126
export const ADVANCED_DIAGNOSTIC_POST_UNIT_TEMPLATE_ID = 0
