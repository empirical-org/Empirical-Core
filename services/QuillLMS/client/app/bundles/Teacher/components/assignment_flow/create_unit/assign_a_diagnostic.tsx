...
const STARTER_DIAGNOSTIC_POST = 'Starter Baseline Diagnostic (Post)'
const INTERMEDIATE_DIAGNOSTIC = 'Intermediate Baseline Diagnostic (Pre)'
const INTERMEDIATE_DIAGNOSTIC_POST = 'Intermediate Baseline Diagnostic (Post)'
const ADVANCED_DIAGNOSTIC = 'Advanced Baseline Diagnostic (Pre)'
const ADVANCED_DIAGNOSTIC_POST = 'Advanced Baseline Diagnostic (Post)'
