...
export default class ChooseClassroomLesson extends React.Component {
  ...
  getClassroomLessonInfo() {
    requestGet(`${process.env.VITE_DEFAULT_URL}/teachers/units/lesson_info_for_activity/${this.props.match.params.activityId}`, (body) => {
      this.setState({
  ...
  launchLessonLink() {
    ...
    return `${process.env.VITE_DEFAULT_URL}/teachers/classroom_units/${classroomUnitId}/launch_lesson/${lessonId}`
  }
  ...
  renderClassroomRow(cu, i) {
    ...
    return (
      <div className={`classroom-row ${selectedClassName} ${completionClass}`} key={i} onClick={clickFunction}>
        <div>
          <img alt="" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/shared/${imgName}.svg`} />
        ...
        <div className='choose-classroom-lessons container gray-background-accommodate-footer'>
          <div className='lesson-section'>
            ...
            <div className="lesson-row">
              <img alt="" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/shared/icon-lesson-box.svg`} />
