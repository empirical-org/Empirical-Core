...
const apSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/college_board/ap.svg`
const preApSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/college_board/pre-ap.svg`
const springBoardSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/college_board/icons-springboard.svg`
