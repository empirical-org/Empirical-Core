...
const multipleAccountSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/icons/icons-account-multiple-check.svg`
const expandSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/icons/expand.svg`
const lockSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/icons/icons-lock.svg`
