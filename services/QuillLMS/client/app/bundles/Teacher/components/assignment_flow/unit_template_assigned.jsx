...
export default class UnitTemplateAssigned extends React.Component {
  ...
  UNSAFE_componentWillMount() {
    requestGet(
      `${process.env.VITE_DEFAULT_URL}/teachers/classrooms_i_teach_with_students`,
      (body) => {
    ...
    requestGet(
      `${process.env.VITE_DEFAULT_URL}/teachers/last_assigned_unit_id`,
      (body) => {
    ...
    requestGet(
      `${process.env.VITE_DEFAULT_URL}/teachers/unit_templates/assigned_info?id=${this.props.match.params.activityPackId}`,
      (body) => {
