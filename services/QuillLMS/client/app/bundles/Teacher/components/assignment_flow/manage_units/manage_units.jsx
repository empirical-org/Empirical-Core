...
export default class ManageUnits extends React.Component {
  ...
  generateNewCaUnit = (u) => {
    ...
    caObj.classroomActivities.set(u.activity_id, {
      ...
      compare_now_with_no_time_zone: u.now_with_no_time_zone ? u.now_with_no_time_zone.replace(' ', 'T') : null,
      compare_now_in_utc: u.now_in_utc ? u.now_in_utc.replace(' ', 'T') : null,
      compare_now_in_est: u.now_in_est ? u.now_in_est.replace(' ', 'T') : null,
      compare_publish_date_with_no_time_zone: u.publish_date_with_no_time_zone ? u.publish_date_with_no_time_zone.replace(' ', 'T') : null,
      compare_publish_date_in_utc: u.publish_date_in_utc ? u.publish_date_in_utc.replace(' ', 'T') : null,
      compare_publish_date_in_est: u.publish_date_in_est ? u.publish_date_in_est.replace(' ', 'T') : null,
      scheduled: u.scheduled,
      compare_scheduled_in_user_time_zone: u.scheduled_in_user_time_zone,
