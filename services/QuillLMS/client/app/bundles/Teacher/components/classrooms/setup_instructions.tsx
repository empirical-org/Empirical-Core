...
const setupInstructionsSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/illustrations/setup-instructions.svg`
const setupInstructionsGenericSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/illustrations/setup-instructions-generic.svg`

const classCodeLinksPdf = `${process.env.VITE_PROCESS_ENV_CDN_URL}/documents/setup_instructions_pdfs/class_code_links.pdf`
