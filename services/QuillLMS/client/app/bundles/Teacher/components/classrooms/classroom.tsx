...
export default class Classroom extends React.Component<ClassroomProps, ClassroomState> {
  ...
  renderClassSettings() {
    ...
    let settings = [
      <button className="quill-button secondary outlined small grey" key={`rename-class-${classroom.id}`} onClick={renameClass} type="button">Rename class</button>,
      <button className="quill-button secondary outlined small grey" key={`change-grade-${classroom.id}`} onClick={changeGrade} type="button">Change grade</button>,
      <button className="quill-button secondary outlined small grey" key={`archive-class-${classroom.id}`} onClick={archiveClass} type="button">Archive</button>
    ]
