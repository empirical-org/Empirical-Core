...
const studentAccountsSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/illustrations/student-accounts.svg`
const joinLinkSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/illustrations/join-link.svg`
