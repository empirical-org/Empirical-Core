...
export default class IndividualStandardsReport extends React.Component {
  ...
  getData() {
    this.setState({loading: true}, () => {
      ...
      const url = selectedStandardId && selectedClassroomId ? `${process.env.VITE_DEFAULT_URL}/teachers/progress_reports/standards/classrooms/${selectedClassroomId}/standards/${selectedStandardId}/students.json` : `${process.env.VITE_DEFAULT_URL}/${sourceUrl}`
      requestGet(
        url,
        (body) => {
