...
export default class CurrentSubscription extends React.Component {
  ...
  onceYourPlanExpires() {
    ...
    if (payment_method !== CREDIT_CARD && (authorityLevel || !purchaser_email)) {
      return <span>{baseText} To renew your subscription for next year, <a href="https://quill.org/request_renewal">contact us</a>.</span>
    }
    if (payment_method !== CREDIT_CARD && !authorityLevel) {
  ...
  contactSales() {
    return (
      <span>
        ...
        at <a href="https://quill.org/request_renewal">sales@quill.org</a>.
      </span>
    )
  }
