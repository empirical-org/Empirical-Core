  ...
  paymentCopy = (endD) => {
    ...
    return (
      <span>
        ...
        {ACCOUNT_TYPE_TO_SUBSCRIPTION_TYPES[account_type]} is valid until
        <strong>{moment(endD).format('MMMM Do, YYYY')}</strong>. Your subscription will auto-renew
        {moment(endD).format('MMMM Do, YYYY')}.
        You can review your subscription information and modify your renewal settings on the subscription page.
      </span>
    );
  };
