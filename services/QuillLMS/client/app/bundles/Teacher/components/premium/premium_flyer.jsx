      ...
      <div className="premium-flyer">
        <div className="inner-premium-flyer">
          <div className="content">
            ...
            <a className="download-button" download="Quill Premium" href="https://assets.quill.org/documents/quill_premium.pdf"><i className="fa fa-file-pdf-o" />Download Premium PDF</a>
          </div>
