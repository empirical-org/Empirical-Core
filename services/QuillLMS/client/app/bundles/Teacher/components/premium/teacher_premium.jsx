        ...
        <div className='container premium-features teacher text-center' id="teacher-premium">
          <section className='premium-features-header'>
            <div className="img-holder">
              <img alt="Presentation board" src={`${process.env.CDN_URL}/images/shared/presentation-board-circle@3x.png`} />
            </div>
          ...
          <div className='premium-features-body'>
            <section>
              <div className="row">
                ...
                <div className="col right">
                  <img alt="Example individual report showing a table of activities scored" src={`${process.env.CDN_URL}/images/shared/activity-scores-report@3x.png`} />
                </div>
              </div>
            </section>
            <section>
            ...
            <section>
              <div className="row">
                ...
                <div className="col right">
                  <img alt="Example standards report showing a table of standards scored by proficiency" src={`${process.env.CDN_URL}/images/shared/standards-report@3x.png`} />
                </div>
              </div>
            </section>
          </div>
