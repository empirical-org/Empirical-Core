...
export const UnitTemplateFilterInputs = ({
  ...
  return(
    <div className="upper-section">
      ...
      />
      {diagnosticsDropdown()}
      <a className='new-unit-template-button quill-button primary contained small focus-on-light' href={`${process.env.VITE_DEFAULT_URL}/cms/unit_templates/new`} rel="noopener noreferrer" target="_blank">New</a>
    </div>
  )
}
