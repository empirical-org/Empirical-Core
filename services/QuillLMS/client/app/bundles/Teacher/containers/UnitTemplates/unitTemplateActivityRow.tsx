...
export const UnitTemplateActivityRow = ({
  ...
  const conceptHeaderElement = (
    <Tooltip
      ...
      tooltipTriggerText={<a className="action-button focus-on-light" href={`${process.env.VITE_DEFAULT_URL}/cms/attributes_manager/activity_categories`} rel="noopener noreferrer" target="_blank">Concept</a>}
  ...
  function activityRows() {
    return activities.map(activity => {
      ...
      const activityLink = `${process.env.VITE_DEFAULT_URL}${anonymous_path}`;
      return {
        id,
