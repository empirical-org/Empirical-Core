...
import StudentReport from '../components/progress_reports/diagnostic_reports/student_report.tsx'
...
export class DiagnosticReports extends React.Component<any, any> {
  render() {
    return(
