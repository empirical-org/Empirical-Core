...
export default class BlogPosts extends React.Component {
  ...
  saveOrder = (topic, blogPosts, ) => {
    const link = `${import.meta.env.VITE_DEFAULT_URL}/cms/blog_posts/update_order_numbers`
  ...
  saveFeaturedOrder = () => {
    const link = `${import.meta.env.VITE_DEFAULT_URL}/cms/blog_posts/update_featured_order_numbers`
    const data = new FormData();
  ...
  onClickStar = (blogPostId) => {
    ...
    const link = `${import.meta.env.VITE_DEFAULT_URL}/cms/blog_posts/${blogPostId}`
