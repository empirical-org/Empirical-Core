...
const logoSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/logos/quill-logo-white-2022.svg`
const mobileLogoSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/logos/quill-logo-white-mobile.svg`
const helpIcon = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/icons/icons-help-white.svg`
        ...
        <div className={`inner-header ${mobileStyle}`}>
          <div className={`left-side-container ${mobileStyle}`}>
            <div className="left-side">
              <a className="focus-on-dark" href={process.env.VITE_DEFAULT_URL}>
