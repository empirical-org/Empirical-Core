  ...
  return(
    <div className="post-activity-slide-container no-focus-outline" ref={containerRef} tabIndex={-1}>
      <section id="information-section">
        <img alt="An illustration of a party popper" id="celebration-vector" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/evidence/party-celebration.svg`} />
        ...
        <section id="reminder-badge-section">
          <img alt="An illustration of an A+ that is crossed out" id="grade-badge" src={`${process.env.VITE_PROCESS_ENV_CDN_URL}/images/evidence/paper-check.svg`} />
