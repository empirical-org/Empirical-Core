...
const baseImgSrc = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/pages/evidence`
...
const ActivitySurvey = ({ activity, dispatch, sessionID, saveActivitySurveyResponse, setSubmittedActivitySurvey, }) => {
  ...
  function handleLinkClick() { window.location.href = process.env.VITE_DEFAULT_URL }
  ...
  return (
    <div className="activity-follow-up-container activity-survey-container no-focus-outline" ref={containerRef} tabIndex={-1}>
      ...
      <div className="button-section">
        <a className="focus-on-dark" href={process.env.VITE_DEFAULT_URL} onClick={handleLinkClick}>Skip</a>
