  ...
  return(
    <React.Fragment>
      ...
      <div className="button-wrapper">
        <button className="add-highlight quill-button-archived small primary outlined" onClick={onAddPlagiarismTextString} type="button">Add Text String</button>
        {!!plagiarismTexts.length && <button className="remove-highlight quill-button-archived small primary outlined" onClick={onRemovePlagiarismTextString} type="button">Remove Text String</button>}
      </div>
      ...
      {plagiarismFeedbacks[0] && (<div className="button-wrapper">
        <button className="add-highlight quill-button-archived small primary outlined" onClick={onHandleAddFeedbackHighlight} type="button" value="0">Add Highlight</button>
      ...
      {plagiarismFeedbacks[1] && (<div className="button-wrapper">
        <button className="add-highlight quill-button-archived small primary outlined" onClick={onHandleAddFeedbackHighlight} type="button" value="1">Add Highlight</button>
