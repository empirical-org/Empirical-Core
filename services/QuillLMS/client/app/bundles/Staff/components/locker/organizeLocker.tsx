...
import { CANCEL, DELETE, DELETE_SECTION_CONFIRMATION, REVERT, REVERT_CONFIRMATION, SAVE, SAVE_CONFIRMATION, lockerItemOptions } from '../../helpers/locker/lockerConstants';
