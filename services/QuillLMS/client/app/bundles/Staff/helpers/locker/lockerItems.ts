import {
  ACTIVITIES,
  ACTIVITY_MANAGEMENT,
  ACTIVITY_PACKS, ACTIVITY_PACKS_CATEGORIES,
  ADMIN_VERIFICATION,
  ANNOUNCEMENTS,
  ARTICLE_IMAGES,
  ATTRIBUTES_MANAGER,
  ...
  MERGE_STUDENT_ACCOUNTS, MERGE_TEACHER_ACCOUNTS,
  ...
  RESTORE_CLASSROOM_UNITS, RESTORE_UNIT_ACTIVITIES,
  SCHOOLS,
  TEACHER_CENTER,
  TEACHER_FIXES,
  TOOLS,
...
export const lockerItems: LockerItemsInterface = {
  ...
  [CURRICULUM]: {
    ...
    lockers: {
      ...
      [ACTIVITY_MANAGEMENT]: [ACTIVITIES, ACTIVITY_PACKS, ACTIVITY_PACKS_CATEGORIES, AUTHORS, RAILS_ADMIN, GEN_AI, TRANSLATIONS],
