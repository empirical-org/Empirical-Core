    ...
    <React.Fragment>
      ...
      <section className="header-image-container">
        ...
        <section className="header-image-information">
          ...
          <Tooltip handleClick={handleImageAttributionClick} tooltipText={tooltipText} tooltipTriggerText="Image credit" tooltipTriggerTextClass="image-attribution-tooltip" />
        </section>
      </section>
    </React.Fragment>
  );
