  ...
  },
  {
    data: {
      play: {
        ...
        prompt:
          "<p>The choppy sea rocks the wooden ship.</p>\n<p>The heavy wind rocks the wooden ship.</p>",
      },
      teach: {
        script: [
          {
  ...
  },
  {
    data: {
      play: {
        ...
        instructions: "Combine the sentences.",
        prompt:
          "<p>The sky turns dark as the storm begins.</p>\n<p>The sea turns dark as the storm begins.</p>",
      },
      teach: {
        script: [
          {
          ...
          },
          {
            data: {
              ...
              heading:
                "Select 1 correct response and 2-3 incorrect responses to display and discuss. ",
            },
            type: "STEP-HTML",
          },
        ],
  ...
  },
  {
    data: {
      play: {
        ...
        instructions: "Combine the sentences.",
        prompt:
          "<p>A downpour of rain soaks the sailors.</p>\n<p>A powerful wave soaks the sailors.</p>",
      },
      teach: {
        script: [
          {
...
export const playClassroomLessonContainerProps = {
  history: {
    ...
    location: {
      ...
      search:
        "?&classroom_unit_id=prvw-50f6ff64-93dc-4354-b24e-ec850ec126c2&student=student",
      hash: "",
    },
  },
  location: {
  ...
  classroomSessions: {
    ...
    data: {
      ...
      supportingInfo:
        "https://assets.quill.org/documents/quill_lessons_pdf/compound_subjects_objects_and_predicates/lesson2_compound_subjects.pdf",
      timestamps: {
      ...
      script: [
        ...
        },
        {
          data: {
            ...
            heading:
              "Select 2-3 correct responses and 1-2 incorrect responses to display and discuss.",
          },
          type: "STEP-HTML",
        },
        {
      ...
      script: [
        ...
        },
        {
          data: {
            ...
            heading:
              "Select 1 correct response and 1 incorrect responses to display and discuss. ",
          },
          type: "STEP-HTML",
        },
      ],
