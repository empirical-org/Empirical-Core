...
const AbsentTeacherIllustration = `${process.env.VITE_PROCESS_ENV_CDN_URL}/images/illustrations/night-sky.svg`
...
const AbsentTeacher = () => (
  <div className="absent-teacher-container full-page-modal-container">
    <div className="absent-teacher full-page-modal">
      ...
      <a className="quill-button focus-on-dark outlined secondary large" href={`${process.env.VITE_DEFAULT_URL}`}>Exit lesson</a>
    </div>
  </div>
)
