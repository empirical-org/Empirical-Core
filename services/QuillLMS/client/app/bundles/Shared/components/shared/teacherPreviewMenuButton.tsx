...
export const TeacherPreviewMenuButton = ({ containerClass, handleTogglePreview }: TeacherPreviewMenuButtonProps) => {
  return(
    <div className={containerClass}>
      <button className="quill-button medium contained white focus-on-dark" id="teacher-preview-menu-button" onClick={handleTogglePreview} type="button">Show menu</button>
    </div>
  );
}
