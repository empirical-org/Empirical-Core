...
const ConceptExplanation = ({ description, leftBox, rightBox, translatedExplanation }) => {
  return (
    <div className={getClassName(description, leftBox, rightBox)}>
      ...
      {!!translatedExplanation?.description && <div className="concept-explanation-description translated" dangerouslySetInnerHTML={{ __html: translatedExplanation?.description }} />}
