...
class UserMailer < ActionMailer::Base
  ...
  def admin_dashboard_teacher_account_created_email(user, admin_name, school_name, is_reminder)
    @user = user
    @admin_name = admin_name
  ...
  def admin_dashboard_admin_account_created_email(user, admin_name, school_name, is_reminder)
    @user = user
    @admin_name = admin_name
    @school_name = school_name
    @set_password_link = ENV['DEFAULT_URL']
  ...
  def admin_dashboard_teacher_link_school_email(user, admin_name, school)
    @user = user
    @admin_name = admin_name
    @school = school
  ...
  def admin_dashboard_made_school_admin_email(user, admin_name, school_name)
    @user = user
    @admin_name = admin_name
    @school_name = school_name
  ...
  def admin_dashboard_made_school_admin_link_school_email(user, admin_name, school)
    @user = user
    @admin_name = admin_name
    @school = school
    @link_school_link = "#{ENV['DEFAULT_URL']}/teachers/#{@user.id}/schools/#{@school.id}"
  ...
  def admin_dashboard_made_school_admin_change_school_email(user, admin_name, new_school, existing_school)
    @user = user
    @admin_name = admin_name
  ...
  def internal_tool_made_school_admin_email(user, school_name)
    @user = user
    @school_name = school_name
    mail to: user.email, subject: "#{user.first_name}, you are now a Quill admin for #{school_name}"
  end

  def internal_tool_made_school_admin_link_school_email(user, school)
    @user = user
    @school = school
    @link_school_link = "#{ENV['DEFAULT_URL']}/teachers/#{@user.id}/schools/#{@school.id}"
    mail to: user.email, subject: "#{user.first_name}, you are now a Quill admin for #{school.name}"
  ...
  def internal_tool_made_school_admin_change_school_email(user, new_school, existing_school)
    @user = user
    @new_school = new_school
    @existing_school = existing_school
    @link_school_link = "#{ENV['DEFAULT_URL']}/teachers/#{@user.id}/schools/#{@new_school.id}"
