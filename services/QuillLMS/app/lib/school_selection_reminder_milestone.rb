module SchoolSelectionReminderMilestone
  ...
  def show_school_selection_reminders
    ...
    !UserMilestone.find_by(milestone_id: dismiss_school_selection_reminder_milestone&.id, user_id: current_user&.id) && [nil, School::NO_SCHOOL_SELECTED_SCHOOL_NAME].include?(current_user.school&.name)
  end
end
