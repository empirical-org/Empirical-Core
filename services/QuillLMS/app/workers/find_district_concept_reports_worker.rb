...
class FindDistrictConceptReportsWorker
  ...
  def perform(admin_id)
    ...
    $redis.set("#{SchoolsAdmins::DISTRICT_CONCEPT_REPORTS_CACHE_KEY_STEM}_#{admin_id}", serialized_district_concept_reports)
    $redis.expire("#{SchoolsAdmins::DISTRICT_CONCEPT_REPORTS_CACHE_KEY_STEM}_#{admin_id}", serialized_district_concept_reports_cache_life)
