module GoogleIntegration
  module Users
    class ClassroomsRetriever
      ACCESS_TOKEN_ERRORS = [
        GoogleIntegration::RefreshAccessToken::RefreshAccessTokenError,
      ...
      private def cache_classrooms_data
        GoogleIntegration::Users::ClassroomsCache.set(user_id, data.to_json)
      end
      ...
      private def set_cache_expiration
        GoogleIntegration::Users::ClassroomsCache.expire(user_id)
      end
