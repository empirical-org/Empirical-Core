...
def evidence_text_helper
  {
    header_text: {
      ...
      second_line: '<p>Designed for 8th-12th grade students, each activity takes 15-20 minutes to complete. These texts cover a wide range of topics, from 21st-century real-world issues to major historical moments and key literary themes.</p>'.html_safe,
