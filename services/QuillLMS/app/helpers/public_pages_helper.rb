  ...
  def evidence_tool_questions_and_answers
    [
      ...
      },
      {
        ...
        answer:
          "<div>
            <p>You can find, preview, and assign Reading for Evidence activities from the <a href='https://www.quill.org/assign/activity-library' rel='noopener noreferrer' target='_blank'>Activity Library</a>, the <a href='https://www.quill.org/assign/featured-activity-packs?type=reading-texts' rel='noopener noreferrer' target='_blank'>Featured Activity Packs page</a>, or our new <a href='/assign/social-studies' rel='noopener noreferrer' target='_blank'>Social Studies</a> and <a href='/assign/interdisciplinary-science' rel='noopener noreferrer' target='_blank'>Interdisciplinary Science</a> pages. We also have a library of resources dedicated to Reading for Evidence in the “Reading Comprehension” section of our Teacher Center. We recommend <a href='https://www.quill.org/teacher-center/introducing-quills-new-writing-and-reading-tool-quill-evidence' rel='noopener noreferrer' target='_blank'>starting with our introductory article</a>.</p>
