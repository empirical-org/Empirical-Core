...
class PagesController < ApplicationController
  ...
  def premium
    ...
    @associated_schools = current_user ? [current_user.school].concat(current_user.administered_schools).uniq.select { |s| School::ALTERNATIVE_SCHOOL_NAMES.exclude?(s.name) } : []
