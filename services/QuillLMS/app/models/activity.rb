...
class Activity < ApplicationRecord
  ...
  OLD_PRE_TEST_DIAGNOSTIC_IDS = [OLD_STARTER_DIAGNOSTIC_ACTIVITY_ID, OLD_INTERMEDIATE_DIAGNOSTIC_ACTIVITY_ID, OLD_ADVANCED_DIAGNOSTIC_ACTIVITY_ID, OLD_ELL_STARTER_DIAGNOSTIC_ACTIVITY_ID, OLD_ELL_INTERMEDIATE_DIAGNOSTIC_ACTIVITY_ID, OLD_ELL_ADVANCED_DIAGNOSTIC_ACTIVITY_ID]
  ALL_PRE_TEST_DIAGNOSTIC_IDS = PRE_TEST_DIAGNOSTIC_IDS + OLD_PRE_TEST_DIAGNOSTIC_IDS
