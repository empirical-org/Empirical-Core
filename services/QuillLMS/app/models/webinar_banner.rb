class WebinarBanner
  ...
  ONE_OFFS = {
    ...
    '11-18-11' => ["Quill's Spotlight on Equitable Grading using Quill", "#{ZOOM_URL}/WN_fggbcB53QcGSjVgqCvCkDQ"],
    '11-18-16' => ["Quill's Spotlight on Equitable Grading using Quill", "#{ZOOM_URL}/WN_BNF3nVnyRVqrKQ9udZis-w"],
    '12-2-11' => ["Quill's Spotlight on Using Quill to Support English Language Learners", "#{ZOOM_URL}/WN_xewDiLaYSEGM3jljnyYKAg"],
    '12-2-16' => ["Quill's Spotlight on Using Quill to Support English Language Learners", "#{ZOOM_URL}/WN_R3h0pKEHTVqiLlNwdFHF4g"],
    '12-9-11' => ["Quill's Spotlight on Sentence Fluency at the Lesson Level", "#{ZOOM_URL}/WN_i4r1iasTS2WqH38mVmabaA"],
    '12-9-16' => ["Quill's Spotlight on Sentence Fluency at the Lesson Level", "#{ZOOM_URL}/WN_M0eiXLFaSEq-GQOAzj0kSA"],
    '12-16-11' => ["Quill's Spotlight on Encouraging & Empowering Your Writers", "#{ZOOM_URL}/WN_1WBmjTBeSTmq_f3Kikkaaw"],
    '12-16-16' => ["Quill's Spotlight on Encouraging & Empowering Your Writers", "#{ZOOM_URL}/WN_yB6Lltm3QH2h4AnobnCdLw"]
  }

  RECURRING = {
    '1-11' => ["Quill 101",  "#{ZOOM_URL}/WN_OmB4MXOgTkWh_jeTFXUTnw"],
    '1-16' => ["Quill 101", "#{ZOOM_URL}/WN_a4Z1_Zs6RSGUWwr_t0V18Q"],
    '2-11' => ["Quill in Pre-AP® and AP®: Spotlight on Data and Instruction", "#{ZOOM_URL}/WN_UuoWsG_8Q5Cpbh9Bqqi24g"],
