# == Schema Information
#
# Table name: vitally_teacher_records
#
...
# Indexes
#
#  index_vitally_teacher_records_on_user_id  (user_id)
#
# Foreign Keys
#
#  fk_rails_...  (user_id => users.id)
#
class VitallyTeacherRecord < ApplicationRecord
  DIAGNOSTIC_ID = 4
  ...
  private def total_students_in_year(school_year_start, school_year_end)
  ...
  private def activities_assigned_in_year_count(user, school_year_start, school_year_end)
  ...
  private def in_school_year(records, school_year_start, school_year_end)
  ...
  private def diagnostics_assigned_in_year_count(user, school_year_start, school_year_end)
