...
--
-- Name: student_activity_sequence_activities; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.student_activity_sequence_activities (
    id bigint NOT NULL,
    activity_id integer NOT NULL,
    classroom_unit_id integer NOT NULL,
...
--
-- Name: student_activity_sequence_activities_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.student_activity_sequence_activities_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: student_activity_sequence_activities_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.student_activity_sequence_activities_id_seq OWNED BY public.student_activity_sequence_activities.id;


--
-- Name: student_activity_sequences; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.student_activity_sequences (
    id bigint NOT NULL,
    classroom_id integer NOT NULL,
...
--
-- Name: student_activity_sequences_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.student_activity_sequences_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: student_activity_sequences_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.student_activity_sequences_id_seq OWNED BY public.student_activity_sequences.id;
...
--
-- Name: student_learning_sequence_activities; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.student_learning_sequence_activities (
    id bigint NOT NULL,
    activity_id integer NOT NULL,
    classroom_unit_id integer NOT NULL,
...
--
-- Name: student_learning_sequence_activities_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.student_learning_sequence_activities_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: student_learning_sequence_activities_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.student_learning_sequence_activities_id_seq OWNED BY public.student_learning_sequence_activities.id;


--
-- Name: student_learning_sequences; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.student_learning_sequences (
    id bigint NOT NULL,
    initial_activity_id integer NOT NULL,
    initial_classroom_unit_id integer NOT NULL,
    user_id integer NOT NULL,
...
--
-- Name: student_learning_sequences_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.student_learning_sequences_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: student_learning_sequences_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.student_learning_sequences_id_seq OWNED BY public.student_learning_sequences.id;
...
--
-- Name: student_activity_sequence_activities id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.student_activity_sequence_activities ALTER COLUMN id SET DEFAULT nextval('public.student_activity_sequence_activities_id_seq'::regclass);


--
-- Name: student_activity_sequences id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.student_activity_sequences ALTER COLUMN id SET DEFAULT nextval('public.student_activity_sequences_id_seq'::regclass);
...
--
-- Name: student_learning_sequence_activities id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.student_learning_sequence_activities ALTER COLUMN id SET DEFAULT nextval('public.student_learning_sequence_activities_id_seq'::regclass);


--
-- Name: student_learning_sequences id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.student_learning_sequences ALTER COLUMN id SET DEFAULT nextval('public.student_learning_sequences_id_seq'::regclass);
...
--
-- Name: student_activity_sequence_activities student_activity_sequence_activities_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.student_activity_sequence_activities
    ADD CONSTRAINT student_activity_sequence_activities_pkey PRIMARY KEY (id);


--
-- Name: student_activity_sequences student_activity_sequences_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.student_activity_sequences
    ADD CONSTRAINT student_activity_sequences_pkey PRIMARY KEY (id);
...
--
-- Name: student_learning_sequence_activities student_learning_sequence_activities_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.student_learning_sequence_activities
    ADD CONSTRAINT student_learning_sequence_activities_pkey PRIMARY KEY (id);


--
-- Name: student_learning_sequences student_learning_sequences_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.student_learning_sequences
    ADD CONSTRAINT student_learning_sequences_pkey PRIMARY KEY (id);
