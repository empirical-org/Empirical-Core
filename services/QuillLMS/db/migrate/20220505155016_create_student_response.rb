...
class CreateStudentResponse < ActiveRecord::Migration[5.1]
  def change
    create_table :student_responses do |t|
      ...
      t.references :student_response_previous_feedback_text, null: false, foreign_key: true, index: {name: 'idx_student_responses_on_student_response_previous_feedback_id'}
