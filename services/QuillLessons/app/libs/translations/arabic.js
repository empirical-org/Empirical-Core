...
const titleCards = {
  'fill in multiple blanks title card': '<h1>A, An, The:املئ الفراغات</h1> <p>.في هذا الجزء من النشاط سيكون لكل جملة فراغين أو ثلاثة فراغات</p><p>.عليك استخدام واحدة من الكلمات في القائمة لملئ الفراغ أو ترك الفراغ اذا كنت تعتقد بان الفراغ لا يحتاج الى اي كلمه</p>',
  'fill in single blanks title card': '<h1>املئ الفراغات</h1><p>.انت على وشك الانتهاء من هذا النشاط! في هذا الجزء من النشاط، عليك ملئ الفراغات باختيار أفضل كلمة لإكمال الجملة</p>',
  'sentence fragments title card': '<h1>جمل كاملة</h1><p>.في هذا الجزء من النشاط سوف تقوم بالاضافه إلى مجموعة من الكلمات لجعل الجملة كاملة. قم باضافه اقل عدد ممكن من الكلمات</p><p>!لنبدا النشاط</p>',
  'tense title card': '<h1>افعال في الماضي والحاضر والمستقبل</h1> <p>.في هذا الجزء من النشاط ستقوم بتصحيح الجمل بوضع الفعل في الزمن الصحيح ليتناسب مع بقية الجملة</p><p>!بالتوفيق</p>',
  'sentence combining title card': '<h1>ربط الجمل </h1><p>.في هذا الجزء من النشاط، عليك ربط الجمل لتكوين جمله واحده</p><p>.قم بربط الجمل باختيار كلمه من مجموعه الكلمات او باستخدام طريقتك الخاصة</p><p>.قم بإضافة أو تغيير الكلمات فقط عند الحاجه وحاول الحفاظ على معنى الجمله</p><p>!حظا سعيدا</p>',
