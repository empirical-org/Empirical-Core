...
const titleCards = {
  'fill in multiple blanks title card': "<h1>Remplir les espaces vides: A, An, The</h1><p>Dans cette section, chaque phrase aura deux ou trois cases espaces vides.</p><p>Vous devez remplir l’espace vide avec l’un des mots d’une liste ou laissez l'espace vide si aucun mot n’est nécessaire.</p>",
  'fill in single blanks title card': "<h1>Remplir l’espace vide</h1><p>Vous en êtes à la moitié des questions ! Dans cette section, vous devez choisir le meilleur mot pour terminer une phrase. Remplissez l’espace vide avec l’un des mots d’une liste.</p>",
  'sentence fragments title card': '<h1>Phrases complètes</h1><p>Dans cette section, vous devez ajouter un ou plusieurs mots à un groupe de mots pour constituer une phrase complète. Ajoutez aussi peu de mots que possible.</p><p>C’est parti !</p>',
  'tense title card': "<h1>Temps passé, présent et futur</h1><p>Dans cette section, vous devez corriger les phrases en mettant le verbe au temps approprié en fonction du reste de la phrase. Vous vous débrouillez très bien jusqu’à présent !</p>",
  'sentence combining title card': "<h1>Combiner de phrases</h1><p>Dans cette section, vous devez combiner plusieurs phrases en une seule.</p><p>Dans certains cas, on vous laissera choisir parmi des mots de liaison, et parfois vous devrez choisir un moyen de combiner les phrases par vous-même.</p><p>Vous devez seulement ajouter ou modifier des mots lorsque vous en avez besoin, tout en essayant de conserver le sens des phrases.</p><p>Vous y êtes !</p>",
  'diagnostic intro text': "<h1>Activité de placement Quill</h1><p>Vous allez répondre à 22 questions sur la rédaction de phrases. Ne vous inquiétez pas, ce n’est pas un contrôle. C’est juste pour déterminer ce que vous savez.</p><p>Certaines questions portent sur des sujets que vous n’avez pas encore appris, donc ne vous faites pas de soucis ! Répondez-y tout simplement de votre mieux.</p><p>Une fois que vous aurez terminé, Quill vous créera un plan d’apprentissage personnalisé !</p>",
