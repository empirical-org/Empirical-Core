...
const FollowUpIllustration = `${process.env.QUILL_CDN_URL}/images/illustrations/celebrating-activity-completion.svg`

const buttonClassName = "quill-button large outlined secondary focus-on-dark"

const generic = <a className={buttonClassName} href={`${process.env.EMPIRICAL_BASE_URL}`}>Exit lesson</a>
